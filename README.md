...
- `GEMINI_API_KEY` / `GEMINI_MODEL` / `GEMINI_TIMEOUT_MS` / `GEMINI_STREAMING` / `GEMINI_MAX_OUTPUT_TOKENS` / `GEMINI_MAX_RETRIES` / `GEMINI_RATE_LIMIT_RETRIES` / `GEMINI_RATE_LIMIT_BACKOFF_MS` / `GEMINI_JSON_REPAIR_TIMEOUT_MS` / `GEMINI_ANSWER_CODE_TIMEOUT_MS` / `GEMINI_COMPLEXITY_TIMEOUT_MS`
